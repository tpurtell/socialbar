...
Socket.prototype.init = function ()
{
  ...
  switch (arguments.length)
  {
    ...
    case 1:
      socketServiceClass = Components.classesByID[arguments[0]];
      break;
...
{
  var rv =   Components.classes["@mozilla.org/binaryinputstream;1"]
...
{
  var rv =   Components.classes["@mozilla.org/scriptableinputstream;1"]
...
{
  if(aStatus == Components.interfaces.nsISocketTransport.STATUS_CONNECTED_TO)
    this._connect_cb();
}
...
Socket.prototype.async = function (observer)
{
  ...
  this._pump = Components.classes["@mozilla.org/network/input-stream-pump;1"]
